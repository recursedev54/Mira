...
class CharacterApp:
    def __init__(self, root):
        ...
        self.definition_text = scrolledtext.ScrolledText(self.tab1, wrap=tk.WORD, width=121, height=19)
        ...
        self.character_listbox = tk.Listbox(self.tab2, width=121, height=19)
        self.character_listbox.pack()
        
        self.chat_log = scrolledtext.ScrolledText(self.tab1, wrap=tk.WORD, width=121, height=19)
        self.chat_log.pack()
    ...
    def save_character(self):
        if not self.selected_character:
            ...
            self.selected_character.definition = self.definition_text.get("0.5", tk.END)
